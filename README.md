...
*Note: You have want to set `ENABLE_SW` to true in the `.env` file to enable the service worker, its just helpful to disable to disable it during development and is false by default*
